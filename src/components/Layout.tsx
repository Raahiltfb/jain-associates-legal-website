  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <Link to="/" className="flex items-center">
              ...
              />
              <div className="text-xl lg:text-2xl font-bold text-primary drop-shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="col-span-1 lg:col-span-2">
              ...
              <div className="flex space-x-4">
                <Button variant="secondary" size="sm" className="bg-green-600 hover:bg-green-700 text-white" asChild>
                ...
                <Button variant="secondary" size="sm" className="bg-blue-600 hover:bg-blue-700 text-white" asChild>
                  <a href="mailto:contact@snehajainlaw.com" className="flex items-center">
                    <Mail className="w-4 h-4 mr-2" />
                    Email
                  </a>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-40">
        <Button size="sm" className="rounded-full shadow-lg bg-green-600 hover:bg-green-700" asChild>
