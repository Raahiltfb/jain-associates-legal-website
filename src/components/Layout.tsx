  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              <Button variant="outline" size="sm" className="border-primary text-primary hover:bg-primary hover:text-white" asChild>
                <a href="tel:+919768181858" className="flex items-center">
                  <Phone className="w-4 h-4 mr-2" />
                  Call Now
                </a>
              </Button>
              <Button size="sm" className="bg-primary hover:bg-primary/90" asChild>
                <a href="mailto:adv.snehajain@gmail.com" className="flex items-center">
                  <Mail className="w-4 h-4 mr-2" />
                  Email Us
                </a>
              </Button>
              <Button size="sm" className="bg-[#25D366] hover:bg-[#20BA5A] text-white" asChild>
            ...
            <div className="px-4 py-2 space-y-1">
              ...
              <div className="pt-4 pb-2 space-y-2">
                <Button variant="outline" size="sm" className="w-full border-primary text-primary hover:bg-primary hover:text-white" asChild>
                  <a href="tel:+919768181858" className="flex items-center justify-center">
                    <Phone className="w-4 h-4 mr-2" />
                    Call Now
                  </a>
                </Button>
                <Button size="sm" className="w-full bg-primary hover:bg-primary/90" asChild>
                  <a href="mailto:adv.snehajain@gmail.com" className="flex items-center justify-center">
                    <Mail className="w-4 h-4 mr-2" />
                    Email Us
                  </a>
                </Button>
                <Button size="sm" className="w-full bg-[#25D366] hover:bg-[#20BA5A] text-white" asChild>
                  <a href="https://wa.me/919768181858" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                    <WhatsAppIcon className="w-4 h-4 mr-2" />
                    WhatsApp
                  </a>
                </Button>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-40">
        <Button size="lg" className="rounded-full shadow-lg bg-[#25D366] hover:bg-[#20BA5A] w-14 h-14 p-0" asChild>
          <a href="https://wa.me/919768181858" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
            <WhatsAppIcon className="w-7 h-7" />
          </a>
        </Button>
        <Button variant="outline" size="lg" className="rounded-full shadow-lg bg-white border-primary text-primary hover:bg-primary hover:text-white w-14 h-14 p-0" asChild>
          <a href="tel:+919768181858" className="flex items-center justify-center">
