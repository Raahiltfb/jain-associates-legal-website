...
Message: ${formData.message}`;
    ...
    const whatsappUrl = `https://wa.me/919768181858?text=${encodeURIComponent(message)}`;
  ...
  const contactInfo = [
    {
      ...
      title: "Phone",
      details: ["+91 97681 81858"],
      action: "tel:+919768181858"
    },
    {
      icon: <Mail className="w-6 h-6 text-primary" />,
      title: "Email",
      details: ["adv.snehajain@gmail.com"],
      action: "mailto:adv.snehajain@gmail.com"
    },
    {
  ...
  const consultationTypes = [
    {
      ...
      action: "https://wa.me/919768181858"
    },
    {
